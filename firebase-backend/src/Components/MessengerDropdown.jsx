...
import { DotsHorizontalIcon, PencilAltIcon, SearchIcon, VideoCameraIcon } from "@heroicons/react/solid";

export const MessengerDropdown = () => {
    return (
        <div className="absolute animate__animated animate__fadeIn animate__faster bg-white-white block dark:bg-dark-200 duration-300 h-96 pb-3 pl-4 pr-4 pt-2.5 right-5 shadow-lg rounded-xl top-14 transition w-96">
            <div className="flex items-center justify-between w-full">
                <h1 className="dark:text-ghost-white font-bold text-2xl bouncing">Messenger</h1>
            ...
            <div className="bg-gray-100 dark:bg-dark-100 flex items-center mt-3 p-1.5 rounded-full bouncing">
                ...
                <input className="bg-transparent dark:placeholder-gray-400 dark:text-white flex-shrink hidden md:inline-flex ml-2 outline-none placeholder-gray-500" type="text" placeholder="Search Messenger" />
            </div>
            <NavLink className="absolute bouncing bottom-4 hover:underline hover:text-blue-500 ml-24 text-blue-500" to="/messenger">See all in Messenger</NavLink>
        </div>
    );
};
...
export const ViewProfilePicture = ({ openViewProfilePicture, profile, setOpenViewProfilePicture }) => {
    return (
            ...
            { openViewProfilePicture &&
                <div className="absolute h-screen inset-0 mx-auto rounded-lg z-50">
                    <div className="absolute left-5 hidden md:flex space-x-4 top-4 z-10">
                        <svg className="animate__animated animate__fadeIn animate__faster cursor-pointer h-7 text-white w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={ () => setOpenViewProfilePicture( false ) }>
                    ...
                    { profile?.profilePicture ?
                        <img alt="" className="animate__animated animate__fadeIn animate__faster h-full object-contain w-full" src={ profile?.profilePicture } />
                        :
                    ...
                    <div className="absolute flex right-3 space-x-4 top-2">
                        <Dropdowns profile={ profile } usedOn="CreateStory" />
                    </div>
                </div>
            }
        </div>

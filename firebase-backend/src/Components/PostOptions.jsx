...
export const PostOptions = ({ createdBy, deletePostHandler, fullName, handleHidePost, openPostOptions, postSaved, profileId, saveHandler, setOpenPostOptions }) => {
    return (
        <>
            <div className="block md:hidden">
                <PostOptionsOverlay openPostOptions={ openPostOptions } onClick={ () => setOpenPostOptions( false ) } />
                    ...
                    { createdBy === profileId ?
                        <>
                            <button className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={ 1.5 } d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />
                                </svg>
                                Pin Post
                            </button>
                            <div className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg" onClick={ saveHandler }>
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={ 1.5 } d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                                </svg>
                                <div className="cursor-pointer">
                                    <h1>{ postSaved ? "" : "Save Post" }</h1>
                                    <p className="text-xs text-gray-600">{ postSaved ? "" : "Add this to your saved items." }</p>
                                </div>
                            </div>
                            <button className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg" onClick={ () => deletePostHandler }>
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={ 1.5 } d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                </svg>
                                <div className="cursor-pointer">
                                    <h1>Delete Post</h1>
                                    <p className="text-xs text-gray-600">Items in your trash are deleted inmediatly.</p>
                                </div>
                            </div>
                            <button className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <>
                            <div className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                ...
                                <div className="cursor-pointer">
                                    <h1>Save Post</h1>
                                    <p className="text-xs text-gray-600">Add this to your saved items.</p>
                                </div>
                            </div>
                            <div className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="cursor-pointer">
                                    <h1>Add { fullName.split(" ")[0] } to Favorites</h1>
                                    <p className="text-xs text-gray-600">Prioritize her/his posts in News Feed.</p>
                                </div>
                            </div>
                            <div className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="cursor-pointer">
                                    <h1>Hide post</h1>
                                    <p className="text-xs text-gray-600">You will never see this post unless you want to.</p>
                                </div>
                            </div>
                            <button className="flex hover:bg-gray-200 transition duration-300 pt-2.5 pb-2.5 w-full items-center font-normal text-black text-lg">
                                <svg className="h-7 w-7 text-black mr-3 ml-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        { createdBy === profileId ?
                            <div className="absolute bg-whiteWhite border-1 border-gray-200 dark:border-dark-400 dark:bg-dark-200 duration-300 hidden md:block pb-2.5 pl-2 pr-2 pt-2 right-5 rounded-lg shadow-lg top-12 transition w-96 z-50">
                                <div className="cursor-pointer duration-300 flex hover:bg-gray-200 dark:hover:bg-opacity-10 mb-2 pb-2.5 pl-2 pr-2 pt-2 rounded-md transition" onClick={ saveHandler }>
                                    ...
                                    <div>
                                        { postSaved ?
                                            <h1 className="animate__animated animate__fadeIn animate__faster dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Post Saved</h1>
                                            :
                                            <h1 className="bouncing dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Save Post</h1>
                                        }
                                        { postSaved ?
                                            <p className="animate__animated animate__fadeIn animate__faster dark:text-gray-400 ml-2.5 mt-0.5 text-gray-500 text-xs">This post is now on your saved items.</p>
                                            :
                                ...
                                <div className="cursor-pointer duration-300 dark:hover:bg-opacity-10 flex hover:bg-gray-200 items-center mt-2 pb-1.5 pl-2 pr-2 pt-1.5 rounded-md transition">
                                    ...
                                    <h1 className="bouncing dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Edit Post</h1>
                                </div>
                                ...
                                <div className="cursor-pointer dark:hover:bg-opacity-10 duration-300 flex hover:bg-gray-200 items-center mt-0.5 pb-1.5 pl-2 pr-2 pt-1.5 rounded-md transition">
                                    ...
                                    <h1 className="bouncing  dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Turn off notifications for this post</h1>
                                </div>
                                ...
                                <div className="cursor-pointer duration-300 flex hover:bg-gray-200 dark:hover:bg-opacity-10 pb-2.5 pl-2 pr-2 pt-2 rounded-md transition" onClick={ deletePostHandler }>
                                    <div className="bouncing">
                                        <svg className="h-7 dark:hidden flex text-gray-700 w-7" fill="none" stroke="currentColor"  viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        <h1 className="bouncing dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Delete Post</h1>
                            ...
                            <div className="absolute bg-whiteWhite border-1 border-gray-200 dark:border-dark-400 dark:bg-dark-200 duration-300 hidden md:block pb-2.5 pl-2 pr-2 pt-2 right-5 rounded-lg shadow-lg top-12 transition w-96 z-50">
                                ...
                                <div className="cursor-pointer duration-300 flex hover:bg-gray-200 dark:hover:bg-opacity-10 mb-2 pb-2.5 pl-2 pr-2 pt-2 rounded-md transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="bouncing dark:text-gray-400 ml-2.5 mt-0.5 text-gray-500 text-xs">Prioritize her/his posts in News Feed.</p>
                                    </div>
                                </div>      
                                <div className="cursor-pointer dark:hover:bg-opacity-10 duration-300 flex hover:bg-gray-200 items-center mt-0.5 pb-1.5 pl-2 pr-2 pt-1.5 rounded-md transition">
                                    <div className="bouncing">
                                ...
                                <div className="cursor-pointer duration-300 flex hover:bg-gray-200 dark:hover:bg-opacity-10 pb-2.5 pl-2 pr-2 pt-2 rounded-md transition" onClick={ handleHidePost }>
                                    <div className="bouncing">
                                        <svg className="h-7 dark:hidden flex text-gray-700 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        <h1 className="bouncing dark:text-gray-200 duration-300 font-medium ml-2.5 text-md transition">Hide Post</h1>
                                        <p className="bouncing dark:text-gray-400 ml-2.5 mt-0.5 text-gray-500 text-xs">You will never see this post unless you want to.</p>
                                    </div>
                                </div>    
                            </div>
                        }

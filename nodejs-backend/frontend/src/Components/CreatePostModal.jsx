...
export const CreatePostModal = ({
  ...
  const { isUploadingPost } = useSelector((state) => state.UiReducer);
                  ...
                  {felling !== "" && (
                    <>
                      ...
                      <p className="bouncing dark:text-white font-semibold text-lg">
                        {profile?.fullName ? "is" : "are"} felling {felling}
                      </p>
                    </>
                  )}
                </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between ml-2.5 mr-2.5 pb-2 pl-3 pr-2.5 pt-2 rounded-xl">
                  ...
                  <div className="flex">
                    {!imageFromFilePicker ? (
                      <PhotographIcon
                        className="bouncing cursor-pointer dark:hover:bg-opacity-10 duration-300 hover:bg-gray-200 h-10 p-1 rounded-full text-green-500 transition w-10"
                        onClick={() => setImageUrlContainer(true)}
                      />
                    ) : (
                      <PhotographIcon
                        className="bouncing bg-green-100 dark:bg-opacity-10 cursor-pointer dark:hover:bg-opacity-10 duration-300 hover:bg-gray-200 h-10 p-1 rounded-full text-green-500 transition w-10"
                        onClick={() => setImageUrlContainer(true)}
                      />
                    )}
              ...
              <div className="mb-2 pl-3 pr-3.5 w-full">
                <button
                  className={`flex dark:hidden disabled:cursor-not-allowed disabled:opacity-70 bg-blue-600 duration-300 focus:outline-none font-semibold mt-3 pb-1.5 pt-1.5 rounded-lg text-center items-center justify-center text-white transition w-full ${
                    ...
                    !isUploadingPost &&
                    "hover:bg-blue-700"
                  } ${isUploadingPost && "bg-opacity-70 cursor-not-allowed"}`}
                  disabled={!imageFromFilePicker || isUploadingPost}
